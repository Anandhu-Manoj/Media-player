  ...
  return (
    <div>
      <div className="row border p-3">
        <div className="col-4">
          <h3>
            <i className="fa-solid fa-music m-2"></i>Media Player
          </h3>
          <p>
        ...
        <div className="col-3">
          <h3>Content</h3>
          <input
            style={{ borderRadius: "5px", margin: "0px",fontSize:"12px",outline:"none" }}
            type="email"
            name=""
            id=""
        ...
        </div><p className="text-center mt-1">Copyright © july 2024 Batch. All Rights Reserved.</p>
      </div>
